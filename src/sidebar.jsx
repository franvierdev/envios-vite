...
export function SideBar() {
  ...
  return <div className="fixed top-0 left-0 w-16 ">
    <button onClick={() => setOpen(true)} className="bg-gray-500 border-2 border-black rounded-lg p-1 ml-4 my-2"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
