    ...
    <div>
      <form onSubmit={handleSubmit} className="grid gap-3 text-center mt-4">
        ...
        to-green-700/90 w-72 rounded-md mx-auto">
          ...
          <input className=' py-1 text-shadow1 text-2xl  font-semibold text-yellow-400 bg-transparent border-gray-700 w-24' placeholder="Dolares"
        ...
        <ul className='flex rounded-md mx-auto justify-between bg-gradient-to-r  from-gray-100/90 to-green-700/90 w-72'>
          ...
          <p className='text-3xl text-gray-100 text-shadow1'>=</p>
          <input className=' px-3 py-1 text-shadow1 text-2xl bg-transparent font-semibold w-24 text-yellow-400' placeholder="Soles" disabled
        ...
        <ul className='flex rounded-md mx-auto justify-between bg-gradient-to-r  from-gray-100/90 to-green-700/90  w-72'>
          ...
          <p className='text-3xl text-gray-100 text-shadow1'>=</p>
          <input className='px-3 py-1 text-shadow1 font-semibold text-2xl text-yellow-400 bg-transparent w-24' placeholder="Pesos" disabled
